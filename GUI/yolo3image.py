...
def yolo3(path):
    ...
    # Opening file
    with open('C:/Users/royri/Downloads/Object Detection Using YOLO/GUI/yolo-coco-data/coco.names') as f:
    ...
    network = cv2.dnn.readNetFromDarknet('C:/Users/royri/Downloads/Object Detection Using YOLO/GUI/yolo-coco-data/yolov3.cfg',
                                         'C:/Users/royri/Downloads/Object Detection Using YOLO/GUI/yolo-coco-data/yolov3.weights')
